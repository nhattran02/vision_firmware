...
void setup_scr_usrdata_screen(lv_ui *ui)
{
    ...
    ui->usrdata_screen_list_id_item11 =lv_list_add_text(ui->usrdata_screen_list_id, "11");
    ui->usrdata_screen_list_id_item12 =lv_list_add_text(ui->usrdata_screen_list_id, "12");
    lv_obj_set_pos(ui->usrdata_screen_list_id, 0, 0);
    ...
    lv_obj_add_style(ui->usrdata_screen_list_id_item12, &style_usrdata_screen_list_id_extra_texts_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_add_style(ui->usrdata_screen_list_id_item11, &style_usrdata_screen_list_id_extra_texts_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->usrdata_screen_list_name_item2 =lv_list_add_text(ui->usrdata_screen_list_name, "Le Vinh Khang");
    ui->usrdata_screen_list_name_item3 =lv_list_add_text(ui->usrdata_screen_list_name, "Nguyen Thien Phu");
    ui->usrdata_screen_list_name_item4 =lv_list_add_text(ui->usrdata_screen_list_name, "Pham Anh Tuan");
    ui->usrdata_screen_list_name_item5 =lv_list_add_text(ui->usrdata_screen_list_name, "Tran Quoc Vinh Quang");
    ui->usrdata_screen_list_name_item6 =lv_list_add_text(ui->usrdata_screen_list_name, "Pham Tran Phuc Hau");
    ui->usrdata_screen_list_name_item7 =lv_list_add_text(ui->usrdata_screen_list_name, "Tran Thi Ngoc Tran");
    lv_obj_set_pos(ui->usrdata_screen_list_name, 40, 0);
    ...
    lv_obj_set_pos(ui->usrdata_screen_list_role, 260, 0);
