...
static void lvgl_task(LCD *self)
{
    while (1) {
                                            ...
                                            switch_on(false)
{
    do
    {
        ...
        xTaskCreate((TaskFunction_t)lvgl_task, "lvgl_task", 5 * 1024, this, 5, NULL);
...
void LCD::run()
{
    xTaskCreatePinnedToCore((TaskFunction_t)lcd_task, TAG, 2 * 1024, this, 5, NULL, 1);
}